...
INSERT INTO clientes(nome, nr_identificacao_civil, nif, data_nascimento)
VALUES('António Oliveira', 937587, 104052455, DATE('1952-10-06', 'yyyy-mm-dd'));  

INSERT INTO clientes(nome, nr_identificacao_civil, nif, data_nascimento)
VALUES('Fernando Santos', NULL, 102000906, TO_DATE('1954-10-10'));                

INSERT INTO clientes(nome, nr_identificacao_civil, nif, data_nascimento)
VALUES('Artur Jorge', 7098428, 100829087, TO_DATE('1946-22-13','yyyy-mm-dd'));    
...
INSERT INTO revisoes(matricula, data_hora_marcacao)
VALUES('83-QD-27', TIMESTAMP('2018-11-04 14:45:00', 'yyyy-mm-dd hh24:mi:ss'));             
...
INSERT INTO revisoes(matricula, data_hora_marcacao, efetuada)
VALUES('XO-65-98', TO_TIMESTAMP('2016-11-22 12:20:00', 'yyyy-mm-dd hh24:mi:ss'), 'x');      